...
const PaymentStripe: React.FC<PaymentStripeProps> = ({
  ...
  const useOptions:
    ...
    return {
      ...
      classes: {
        base: "pt-3 pb-1 block w-full h-11 px-4 mt-0 bg-ui-bg-field border rounded-md appearance-none focus:outline-none focus:ring-0 focus:shadow-borders-interactive-with-active border-neutral hover:bg-ui-bg-field-hover",
      },
    }
  }, [])
