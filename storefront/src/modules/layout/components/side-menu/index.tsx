          ...
          {({ open, close }) => (
            <>
              <div className="relative flex h-full">
                <Popover.Button className="relative h-full flex items-center transition-all ease-out duration-200 focus:outline-none text-base-content hover:text-secondary">
                  Menu
                </Popover.Button>
              </div>
