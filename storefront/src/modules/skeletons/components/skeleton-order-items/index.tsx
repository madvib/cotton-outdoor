      ...
      <div className="grid grid-cols-[122px_1fr] gap-x-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex flex-col gap-y-2">
            <div className="w-48 h-6 bg-base-200"></div>
            <div className="w-24 h-4 bg-base-200"></div>
            <div className="w-32 h-4 bg-base-200"></div>
          </div>
          <div className="w-32 h-6 bg-base-200"></div>
        </div>
      </div>
